    ...
    Array.from(dom.window.document.querySelectorAll(`table`))
        .map(function (element) {
          ...
          var friday, saturday, sunday
            ...
            // Iterate over tableheads (If layout is same - th.length == td.length) If the tablecell connected to the tablehead is valued 'ok', set variable to true.
          ...
          // Store what days said person is available and then return the object.
